...
router.patch('/reserva_ambientes', reserva_ambientesController.editarreserva_ambientes);
router.delete('/reserva_ambientes', reserva_ambientesController.apagarreserva_ambientes);
